...
class Cell:
    ...
    def __str__(self):
        return f'Количество ячеек в клетке {self.num}'
    ...
    def __sub__(self, other):
        if self.num - other.num < 0:
            print("При вычитании получилось отрицательное число")
            return None
        else:
            return Cell(self.num - other.num)
    ...
    def make_order(self, cell, n):
        a, b = divmod(cell.num, n)
        return '\n'.join(['*' * n for i in range(a)] + ['*' * b])
